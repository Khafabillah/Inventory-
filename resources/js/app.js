...
// Mengambil data dari Laravel, jika gagal ambil data dummy
const dynamicLabels = window.dashboardData?.barLabels || ['Showroom', 'Gudang', 'Service', 'HR', 'Lounge', 'Bengkel'];
const dynamicData = window.dashboardData?.barData || [800, 680, 150, 80, 320, 20];
...
data: dynamicData,
backgroundColor: [
'#73FF70', '#77E4FF', '#FF7CE7', '#F15F61', '#646764', '#5F64F1', '#F59E0B', '#10B981'
],
borderRadius: 8,
barThickness: 35,
}]
...
// Render Custom Legend (Tanda % diganti menjadi 'Aset' agar sesuai dengan jumlah asli dari database)
...
// 1. Fungsi Universal untuk Membuka/Menutup Modal (Tambah Aset & QR Code)
...
// 2. Fungsi untuk Mengisi Data Dinamis ke Modal QR Code
...
// Memanggil rute internal Laravel: /aset/qr/{kode-aset}
...
// 3. Fungsi untuk Mencetak Area Spesifik (Label QR)
window.printQR = function() {
const printContent = document.getElementById('printArea').innerHTML;
const originalContent = document.body.innerHTML;

// Ganti isi body hanya dengan area cetak
...
// 4. Logika Menghilangkan Notifikasi Sukses Secara Otomatis
...
// Fungsi Mengontrol Buka/Tutup Dropdown Titik Tiga
...
// Menutup dropdown otomatis jika user mengklik area kosong di layar
