<aside class="w-[225px] bg-[#C8DEEF] h-screen flex-shrink-0 flex flex-col hidden lg:flex border-r border-[#b5cce0]">
    ...
    <nav class="flex flex-col px-4 pt-8 space-y-2">
        ...
        <a href="/log-aktivitas" class="flex items-center gap-4 px-5 py-4 {{ request()->is('log-aktivitas') ? 'bg-white shadow-[0_4px_10px_rgba(0,0,0,0.05)] text-[#071437]' : 'text-[#6388a7] hover:bg-white/50 hover:text-[#071437]' }} rounded-2xl font-semibold transition-all">
            <svg class="w-6 h-6 {{ request()->is('log-aktivitas') ? 'text-[#FFCD29]' : 'text-[#006EC4]' }}" viewBox="0 0 24 24"><path fill="currentColor" d="M12 21q-3.45 0-6.012-2.287T3.05 13H5.1q.35 2.6 2.313 4.3T12 19q2.925 0 4.963-2.037T19 12t-2.037-4.962T12 5q-1.725 0-3.225.8T6.25 8H9v2H3V4h2v2.35q1.275-1.6 3.113-2.475T12 3q1.875 0 3.513.713t2.85 1.924t1.925 2.85T21 12t-.712 3.513t-1.925 2.85t-2.85 1.925T12 21m2.8-4.8L11 12.4V7h2v4.6l3.2 3.2z"/></svg>
